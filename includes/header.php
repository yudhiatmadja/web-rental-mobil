        ...
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:info@example.com">ngalam_rental@gmail.com</a>
            </div>


            <div class="social-follow horizontal-icons">
              <ul>
                <li><a href="https://wa.me/6289508748809" target="_blank"><i class="fa fa-whatsapp" aria-hidden="true"></i></i></a></li>
                <li><a href="https://www.linkedin.com/in/yudhiiatmadja/" target="_blank"><i class="fa fa-linkedin-square" aria-hidden="true"></i></a></li>
                <li><a href="https://www.instagram.com/rektaacb/" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
              </ul>
            </div>
